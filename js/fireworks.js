var canvas = document.getElementById("cas");
    ...
    var scene = document.querySelector(".oneScene");
    ocas.width = canvas.width = scene.offsetWidth;
    ocas.height = canvas.height = scene.offsetHeight;
    var bigbooms = [];
    ...
    function drawMoon(){
        ...
        var centerX = canvas.width-100 , centerY = 150 , width = 40;
        if(moon.complete){
